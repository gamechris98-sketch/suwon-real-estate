...
def fetch_naver_asking_prices():
    ...
    default_presets = {
        ...
        'mangpo_hillstate':   (140000, 160000, 170000), # 힐스테이트영통 (14.0억 ~ 16.0억 ~ 17.0억)
        'mangpo_ipark':       (138000, 145000, 155000), # 영통아이파크캐슬1단지 (13.8억 ~ 14.5억 ~ 15.5억)
        'mangpo_skview':      (105000, 112000, 118000), # 영통SKVIEW (10.5억 ~ 11.2억 ~ 11.8억)
        'mangpo_sujain':      (94000,  97000,  102000), # 망포 한양수자인에듀파크 (9.4억 ~ 9.7억 ~ 10.2억)
        'yeongtong_edupark':  (95000, 100000, 118000), # 영통 에듀파크 (최저 9.5억 ~ 대표 10.0억 ~ 최고 11.8억)
        'yeongtong_dongbo':   (79000,  86000,  90000),  # 신나무실동보 (7.9억 ~ 8.6억 ~ 9.0억)
        'yeongtong_shinmyung': (72000, 76000,  80000),  # 신나무실신명 (7.2억 ~ 7.6억 ~ 8.0억)
        'yeongtong_geukdong': (86000,  89000,  93000),  # 신나무실극동 (8.6억 ~ 8.9억 ~ 9.3억)
        'yeongtong_punglim':  (88000,  91000,  95000),  # 신나무실풍림 (8.8억 ~ 9.1억 ~ 9.5억)
        'maetan_weve':        (83000,  88000,  90000),  # 매탄위브하늘채 (8.3억 ~ 8.8억 ~ 9.0억)
        'maegyo_skview':      (99000, 115000, 131000), # 매교역푸르지오SK뷰 (9.9억 ~ 11.5억 ~ 13.1억)
        'maegyo_hillstate':   (88000,  98000,  120000)  # 힐스테이트푸르지오수원 (8.8억 ~ 9.8억 ~ 12.0억)
    }
...
const INJECTED_AREA_GAP = {json.dumps(area_gap_data, ensure_ascii=False)};
const INJECTED_PEER_GAP = {json.dumps(peer_gap_data, ensure_ascii=False)};
